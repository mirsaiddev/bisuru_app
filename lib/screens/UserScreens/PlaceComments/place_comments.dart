                              ...
                              children: [
                                ...
                                Row(mainAxisSize: MainAxisSize.min, children: [
                                  ...
                                  Builder(builder: (context) {
                                    return Row(
                                      children: [
                                        for (int i = 0; i < commentModel.rating; i++) Icon(Icons.star, color: MyColors.yellow, size: 16),
                                        for (int i = 0; i < 5 - commentModel.rating; i++) Icon(Icons.star, color: MyColors.grey, size: 16),
                                      ],
                                    );
                                  })
                                ]),
